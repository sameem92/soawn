...
export default class WorkSend_En extends Component {
  state = {
    checked : false,
  }
  ...
  render() {
    ...
    <ScrollView>
      ...
      style={{
        ...
        ><Text style={{textAlign :'center'}}>Attach An Image</Text></View>
...
<View
        ...
        ><Text style={{textAlign :'center'}}>Attach An Video</Text></View>
