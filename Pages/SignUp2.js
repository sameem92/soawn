          ...
          uploadImage(this.state.ProfileImage, this.state.ProfileImagetype, `${unqiuid}_ProfileImage`, () => {
            ...
            uploadImage(this.state.CertifcateImage, this.state.CertifcateImagetype,  `${unqiuid}_CertifcateImage`, () => {
                  ...
                  uploadImage(this.state.IDGETIMAGE, this.state.IDGETIMAGEtype,  `${unqiuid}_IDGETIMAGE`, () => {
                    ...
                    Actions.Thankspage_EN({ Email : this.state.Email, Type_ : 'Freelancer'} );


                  }, () =>  this.pushError('Try again you have no internet'));        
                }, () => {
                  this.pushError('Try again you have no internet')
                });
            ...
            true,
        ["ID", "==", this.state.ID],
        () => this.pushError('try again with other "ID"'),
    ...
    <ScrollView>
      ...
      <View style={{
        ...
        <View   style={{
          ...
          <Text style={{textAlign: 'center'}}>Copy of ID</Text>
        </View>
        ...
        <View   style={{
          ...
          <Text style={{textAlign: 'center'}}>Copy of Granulation Certificate</Text>
        </View>
...
<View   style={{
  ...
  <Text style={{textAlign: 'center'}}>Choose your Email image</Text>
</View>
...
<View style={{
        ...
        <Picker
          ...
          <Picker.Item label="Plumbing" value="1" /> 
          <Picker.Item label="AC" value="2" />
          <Picker.Item label="Electricity" value="3" />
          <Picker.Item label="Phone and Computers" value="4" />
          <Picker.Item label="Paint and Dyes" value="5" />
        </Picker>
...
<CheckBox
        ...
        <Text style={{color : '#fff', fontSize: 16}}>{ this.state.loading__ == false ? "LOG IN" : 'Loading ...'}</Text>
</View>
</TouchableWithoutFeedback>
        </View>
