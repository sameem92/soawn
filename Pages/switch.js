...
export default class Switch_AR extends Component {
  state = {
    checked : false,
  }
  ...
  render() {
    ...
    <ScrollView>
      ...
      style={{
        ...
        <TouchableWithoutFeedback onPress={() => Actions.Login_EN({needwork : true})}>
      ...
      <ImageBackground style={{
        ...
        <Text style={{ fontSize: 19, color : '#23577c'}}>Student Service</Text>
      </View>

        </TouchableWithoutFeedback>

        <TouchableWithoutFeedback onPress={() => Actions.Login_EN({needwork : false})}>
      ...
      <View style={{
        ...
        <Text style={{ fontSize: 19,  color : '#23577c'}}>Tenant</Text>
